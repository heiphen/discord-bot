...
export const handleGetCountAll = async (incomingMessage: Message, userRoleCol: Collection) => {
    try {
        await userRoleCol.find({}).toArray((err, res) => {
            ...
            .addFields([{ name: "Code", value: "------", inline: true}, { name: "Role Assigned", value: "-----------------", inline: true}, { name: "Users who used this code", value: "------------------------------", inline: true}, ...fields])
            .setTimestamp()
